...
var debug = require('debug')('taskcluster-docker-worker:volumeCache');
...
export default class VolumeCache {
  ...
  */
  async createCacheVolume(cacheName) {
    ...
    if(!(await fs.exists(cachePath))) {
      ...
      debug('cache volume created', cacheDetails);
    }
  }
  ...
  */
  async release(cacheKey) {
    ...
    debug("cache volume release", {key: cacheKey});
  }
